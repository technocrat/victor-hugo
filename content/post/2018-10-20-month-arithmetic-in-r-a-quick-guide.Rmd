...
![Excel eample](/post/2018-10-20-month-arithmetic-in-r-a-quick-guide_files/2018-10-20-ExcelMonthDate.png)
...
Just to throw in a ringer, which is again semi-inclusive.

![WolframAlphas's natural language interpretation](2018-10-20-WolframmonthDate.png)
...
Next, I tried the *lubridate* package [^1], and it seemed to provid a way forward. From the documentation:
...
It took a while to digest that, but it seemed promising. The key difference with other approaches is that **mondate** measures in *months* from the beginning of its epoch, rather than *seconds.* Put another way, relevant in light of the pending GAAP change in 2019
