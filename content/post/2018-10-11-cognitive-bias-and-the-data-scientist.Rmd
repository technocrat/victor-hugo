...
Now, comes the hard part. She already knew that only one of the other doors had the real prize, and since there were two of them, the chances were 50-50, *between them*. Gaining the knowledge of *which one* of the doors had the winning 50% chance changed her estimate of the odds of the *remaining* door relative to the open door, but it did nothing (or should have done nothing) to change the estimate of *her* door relative to the **joint** probability of the other two doors.

More simply, she started with a 1:3 chance of winning. She still has a 1:3 chance of winning, but **she still now knows** that the remaining alternative has a 2:3 chance of winning. Therefore, she doubles her chances by switching.
